        ...
        <section className='mt-[3rem]'>
            ...
            <div className='w-4/5 mx-auto grid grid-cols-1 sm:grid-cols-2 gap-4 ]'>
                ...
                <div className='flex flex-col items-center justify-center h-[30vh] bg-slate-200 p-3 sm:p-10'>
                    ...
                    <h2 className='text-[18px] sm:text-2xl font-semibold'>Grab offer(any sellers product)</h2>
                    <p className='text-sm text-center'>If your single time purchase is over 50k you can have a special card. Get 20% discount with that card.Validity is 30days.</p>
                </div>
            </div>
        </section>
    );
